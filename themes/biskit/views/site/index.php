					...
					<div class="art-content-layout">
						<div class="art-content-layout-row">
							<div class="art-layout-cell layout-item-0" style="width: 25%;">
								...
								<p><span style="color: rgb(255, 255, 255);">Ingresa a todos tus alumnos deudores.</span></p>
							...
							<div class="art-layout-cell layout-item-1" style="width: 25%;">
								...
								<h4>Portable</h4>
								<p><span style="color: rgb(255, 255, 255);">Entra desde cualquier equipo con internet.</span></p>
							...
							<div class="art-layout-cell layout-item-0" style="width: 25%;">
								...
								<h4>Reportes</h4>        
								<p><span style="color: rgb(255, 255, 255);">Descubre que alumnos tienen deudas en otras instituciones.</span></p>
						
							</div>
	
							<div class="art-layout-cell layout-item-1" style="width: 25%;">
								<p><img width="64" height="64" alt="" src="<?php echo Yii::app()->theme->baseUrl; ?>/css/images/escudo2.png" style="float:left;margin-right:10px; margin-bottom:20px;" /></p>
								<h4>Protegete</h4>
								<p><span style="color: rgb(255, 255, 255);">Evita problemas con alumnos.</span></p>
